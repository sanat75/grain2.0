...
const Customer = () => {
  return (
    <div className="h-full w-full flex flex-col gap-8 md:gap-0 justify-center items-center md:flex-row md:justify-between px-4">
      <div className="w-full h-full  md:w-1/2">
        <div className="font-bold pt-10 text-center md:text-start space-y-5">
