...
const Seprator = () => {
  return (
    <Wrapper className="relative p-4 sm:rounded-3xl sm:w-4/5 my-10 sm:my-30 h-80  text-white flex justify-center items-center bg-[#071C33]">
      <Image
        alt="get in touch"
      ...
      <div className="absolute flex flex-col justify-center items-center ">
        <h1 className="text-3xl md:text-4xl font-bold text-primary-secondary my-3">
