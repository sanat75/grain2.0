...
const Brands = () => {
  ...
  return (
    <main className="relative flex flex-col justify-center bg-secondary overflow-hidden">
      <div className="w-full px-4 md:px-2">
        <div className="text-center">
          <div className="w-full inline-flex flex-nowrap overflow-hidden [mask-image:_linear-gradient(to_right,transparent_0,_black_128px,_black_calc(100%-128px),transparent_100%)]">
            ...
            >
              <li className="w-48 flex items-center justify-center  h-48 ">
                <Image
                  src={"/assets/images/grain-client-logos/aldo.svg"}
                  alt="aldo"
                  width={150}
                  height={150}
                  className="hover:text-gray-900 grayscale hover:grayscale-0 transition ease-in-out dark:hover:text-white"
                />
              </li>
              <li className="w-48 flex items-center justify-center rounded  h-48 ">
                <Image
                  src={"/assets/images/grain-client-logos/Bell.svg"}
                  alt="aldo"
                  width={150}
                  height={150}
                  className="grayscale hover:grayscale-0 transition ease-in-out hover:text-gray-900 dark:hover:text-white"
                />
              </li>
              <li className="w-48 flex items-center justify-center rounded  h-48 ">
                <Image
              ...
              <li className="w-48 flex items-center justify-center rounded  h-48 ">
                <Image
                  ...
                  width={150}
                  height={150}
                  className="hover:text-gray-900 grayscale hover:grayscale-0 transition ease-in-out bg-black p-2 dark:hover:text-white"
                />
              </li>
              <li className="w-48 flex items-center justify-center rounded  h-48 ">
                <Image
